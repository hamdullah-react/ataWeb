      ...
      <div className="container-fluid px-xl-5">
        ...
        <div className="row g-3 mb-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-4 md:p-5 border border-gray-100">
              ...
              <form name="sentMessage" id="contactForm" noValidate>
                ...
                <div className="mb-3">
                  ...
                  <input
                    type="text"
                    className="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 focus:border-green-500 focus:outline-none transition-all duration-300"
                    id="name"
                ...
                <div className="mb-4">
                  ...
                  <textarea
                    className="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 focus:border-green-500 focus:outline-none transition-all duration-300 resize-none"
                    rows={4}
                    id="message"
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-4 py-2.5 text-sm rounded-full font-semibold transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center gap-2"
                >
          ...
          <div className="col-lg-5">
            <div className="bg-white rounded-xl shadow-md p-4 md:p-5 border border-gray-100 h-100">
              <div className="mb-4">
                <h2 className="text-lg md:text-xl font-bold text-gray-800 mb-1">
                  Get In Touch
                </h2>
              ...
              {/* General Manager */}
              <div className="bg-gradient-to-r from-green-50 to-green-100 rounded-lg p-3 mb-4 border-l-4 border-green-600">
                <p className="text-xs text-gray-600 mb-0.5">General Manager</p>
              ...
              <div className="space-y-2">
                {contactInfo.map((info, index) => (
                  <div
                    key={index}
                    className="flex items-start gap-3 p-2.5 rounded-lg hover:bg-gray-50 transition-all duration-300"
                  >
                    <div className="w-9 h-9 bg-green-100 rounded-full flex items-center justify-center flex-shrink-0">
                      <i
                        className={`fa ${info.icon} text-green-600 text-sm`}
                      ></i>
                    </div>
                    <div className="flex-grow">
                      ...
                      {info.href ? (
                        <a
                          href={info.href}
                          className="text-sm text-gray-800 hover:text-green-600 transition-colors no-underline"
                        >
                          {info.value}
                        </a>
                      ) : (
              ...
              <div className="mt-4">
                <a
                  ...
                  className="w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white px-4 py-2.5 text-sm rounded-full font-semibold transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center gap-2 no-underline"
                >
            ...
            <div className="bg-white rounded-xl shadow-md p-3 border border-gray-100">
              <div className="mb-3">
                <h3 className="text-base md:text-lg font-bold text-gray-800 flex items-center gap-2">
                  <i className="fa fa-map-marker-alt text-green-600 text-sm"></i>
                  Our Location
                </h3>
              </div>
